...
"" \
"Move to index" "m" "command-prompt -p \"Move window to index:\" \"move-window -t ':%%'\"" \
"Swap with index" "s" "command-prompt -p \"Swap with window index:\" \"swap-window -t ':%%'\"" \
Renumber "#" "move-window -r" \
"" \
...
"Show numbers" "#" "display-panes -d 5000" \
"" \
Left "h" "selectp -L" \
Down "j" "selectp -D" \
Up "k" "selectp -U" \
...
"Kill selected" "X" "choose-tree -sZ \"kill-session -t '%%'\""'
